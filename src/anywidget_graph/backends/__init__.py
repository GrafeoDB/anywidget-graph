...
from anywidget_graph.backends.cosmosdb import CosmosDBBackend
...
class DatabaseBackend(Protocol):
    ...
    - execute(query, *, language) -> (nodes, edges)
...
BACKENDS = [
    ...
    {"id": "cosmosdb", "name": "Azure CosmosDB", "side": "python", "language": "gremlin"},
]
